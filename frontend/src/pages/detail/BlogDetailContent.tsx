...
const BlogDetailContent = () => {
  const [blog, setBlog] = useState<Blog>({
    id: 0,
    title:
      "Sinh viên Đại học Gia Định – Đảng viên trẻ tích cực với các hoạt động xã hội",
    category: "Hoạt động sinh viên",
    excerpt:
      "ĐNO – Không chỉ là một đảng viên trẻ gương mẫu, sáng tạo góp phần quan trọng vào sự phát triển của tổ chức cơ sở đảng, anh Nguyễn Trường Giang còn là một thanh niên năng nổ, nhiệt huyết, sáng tạo với nhiều hoạt động, phong trào thiết thực, bổ ích, thu hút đông đảo đoàn viên, thanh niên tham gia.",
    slug: "abc-xyz",
    date: "01/01/2023",
    coverImage:
      "https://tuoitredaihocdonga.org.vn/wp-content/uploads/2024/10/images1751513_anh_1_copy.jpg",
    content:
      "\n" +
